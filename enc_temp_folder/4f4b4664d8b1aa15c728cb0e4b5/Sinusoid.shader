...
vec3 RainbowMapping(float xyzCoord)
{
    ...
    float r = SmoothRainbowComponent(normalizedCoord + 0.0);
    float g = SmoothRainbowComponent(normalizedCoord + 0.33);
    float b = SmoothRainbowComponent(normalizedCoord + 0.67);
